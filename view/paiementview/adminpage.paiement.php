    ...
    <tbody>
      ...
      <?php if ($res != 0){ foreach ($respaiement as $key => $unPaiement) { ?>
        ...
        <tr>
          ...
          <td><?=$unPaiement->getIdAdherent();?> (<?php if ($adh->getNom() == null) {echo"Pas d'adherent";}else{ echo $adh->getNom(); echo ","; echo $adh->getPrenom(); }?>)</td><!--Lien vers l'adherents pour savoir qui c -->
          <td>
